package com.evertonriquetti.bookstoremanager.service;

import com.evertonriquetti.bookstoremanager.dto.BookDTO;
import com.evertonriquetti.bookstoremanager.entity.Book;
import com.evertonriquetti.bookstoremanager.exception.BookNotFoundException;
...
import static com.evertonriquetti.bookstoremanager.utils.BookUtils.createFakeBook;
...
public class BookServiceTest {
    ...
    void whenGivenExistingIdThenReturnThisBook() throws BookNotFoundException {
        ...
        assertEquals(expectedFoundBook.getName(), ((BookDTO) bookDTO).getName());
